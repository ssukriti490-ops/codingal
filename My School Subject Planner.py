student_profile = ("Rahul", "Grade 5", "Section B", 8)
...
monday_subjects = {"Math", "Physics", "English", "Computer", "Biology", "S.S.T", "Art"}
tuesday_subjects = {"Math", "Chemistry", "English", "Games", "Drawing", "Music"}
